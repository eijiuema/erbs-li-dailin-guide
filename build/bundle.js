    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t141 = space();
    			p36 = element("p");
    			p36.textContent = "Numa situacão perfeita, o combo com o maior dano é aquele que maximiza o uso da passiva, por exemplo:";
    			t143 = space();
    			...
    			add_location(h15, file, 351, 6, 12590);
    			attr_dev(q4, "class", "question svelte-bo7kk5");
    			add_location(q4, file, 352, 6, 12612);
    			...
    			add_location(img2, file, 357, 6, 12795);
    			add_location(p35, file, 358, 6, 12841);
    			add_location(p36, file, 363, 6, 13045);
    			if (!src_url_equal(source6.src, source6_src_value = "resources/combos/Combo.mp4")) attr_dev(source6, "src", source6_src_value);
    			add_location(source6, file, 365, 8, 13237);
    			...
    			add_location(video6, file, 364, 6, 13161);
    			attr_dev(section11, "class", "svelte-bo7kk5");
    			add_location(section11, file, 350, 4, 12574);
